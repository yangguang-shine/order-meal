	...
	<div class="order-detail-container">
		<div class="order-detail-header">
			<div class="flex-row flex-j-between">
				<div class="order-status">订单待接单</div>
			...
			<div class="order-button-box flex-row">
				<div class="button-item" :style="{'color': $mainColor}"></div>
			</div>
		</div>
...
import host from '@/config/host'
	...
	export default {
		...
		methods: {
			...
			// },
			// async getFoodList() {
			// 	const res = await this.$fetch.get('/api/order/foodList', { orderKey: this.orderKey })
			// },
			copyOrderKey() {
				wx.setClipboardData({
