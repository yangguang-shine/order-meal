<template>
    <view :animation="shopInfoAnimationData" class="shop-info-container">
        ...
        <view v-if="shopInfo.minusList" class="shop-item flex-row flex-a-center flex-j-between">
            ...
            <MinusList v-if="shopInfo.minusList.length" :minusList="shopInfo.minusList.length > 6 ? shopInfo.minusList.slice(0, 6) : shopInfo.minusList" :mainColor="shopInfo.mainColor"></MinusList>
...
// state
const { shopInfo, startShopInfoAnimationFlag }: MenuStateG = toRefs(menuStore.menuState)
