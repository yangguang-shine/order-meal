<template>
  <div class="shop-edit-container">
    ...
    <div class="flex-row flex-a-center">
      ...
      <image class="food-img" mode="scaleToFill" :src="shopInfo.fullImgUrl" @click="chooseImg"></image>
    </div>
        ...
        success: res => {
          ...
          uni.uploadFile({
            ...
            success: async res => {
              ...
              this.shopInfo.imgUrl = imgUrl
              this.shopInfo.fullImgUrl = `${shopImgPrePath}/${imgUrl}`
              this.$hideLoading();
              this.$showModal({
                content: '上传成功'
              });
